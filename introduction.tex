...
Scrolling is the action of moving displayed text or graphics up, down, or across a computer screen, in order to view different parts of the spreadsheet.
...
Steering, on the other hand, involves clicking the left mouse button and then dragging the mouse pointer through the spreadsheet to select a specific region. For example, to issue a formula,
...
Following the construction of a dynamic overview, 
...
a multi-granularity overview is constructed and displayed
...
The study shows that compared to Microsoft Excel, participants were able to complete spreadsheet
