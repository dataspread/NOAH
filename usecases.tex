...
scenarios, including
developing models for visualization system design~\cite{meyer2015nested}, 
designing task taxonomies for cartograms~\cite{mcnabb2017survey}, 
and defining the scope of tasks in a number of domains, 
\eg interactive task authoring~\cite{fulda2015timelinecurator},
 document mining~\cite{brehmer2014overview}, 
 multivariate network analysis~\cite{pretorius2014tasks}, 
 mass cytometry~\cite{hollt2016cytosplore}, among others.
